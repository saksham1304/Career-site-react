...
export default ({
  ...
  const defaultFaqs = [
    {
      question: "What is a Career Guidance and Counseling Program?",
      answer:
    ...
    {
      question: "Why is Career Guidance and Counseling Key to the Delivery of Vocational-Technical Education?",
      answer:
    ...
    {
      question: "How does the Aptitude, Personality and Interest based assessment help in selecting a career?",
      answer:
