...
export default ({
  ...
  description = "Want to have want to take a career guidance test",
  plans = null,
  primaryButtonText = "Buy Now",
  planDurations = [
    {
      text: "OneTime",
      switcherText: "OneTime",
    },
  ...
  const defaultPlans = [
    {
      name: "Free Plan",
      durationPrices: ["INR0", "$0"],
      mainFeature: "Basic",
      features: ["If you choose to take the test and avail the report."]
    },
    {
      name: "Recommended Plan",
      durationPrices: ["INR499", "$499"],
      mainFeature: "Detailed",
      features: ["You take the test, get a detailed report and avail the counselling from the Career Point expert."],
      featured: true
    }
  ];
        ...
        <PlansContainer>
          {plans.map((plan, index) => (
            <Plan key={index} featured={plan.featured}>
              ...
              <PlanAction>
                <BuyNowButton onClick={handleSubmission}>{primaryButtonText}</BuyNowButton>
              </PlanAction>
            </Plan>
          ))}
        </PlansContainer>
